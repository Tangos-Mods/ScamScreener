...
public final class EducationMessages {
     ...
     */
    public static MutableComponent followUpFor(PipelineDecision decision) {
    ...
    static MutableComponent followUpFor(PipelineDecision decision, Collection<String> disabledMessageIds) {
    ...
    static MutableComponent followUpComponent(String messageId) {
